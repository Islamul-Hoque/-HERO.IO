...
const Banner = () => {
    return (
        <div className='mt-6'>
            <h2 className=' leading-14 mb-3 text-center font-bold text-[2.5rem] md:text-[3rem] text-[#001931]  '>We Build <br /> <span className='bg-[linear-gradient(125.07deg,#632ee3,#9f62f2_100%)] bg-clip-text text-transparent'>Productive</span> Apps</h2>
            ...
            <div className='flex justify-center items-center'><img className='w-[80%] md:w-[55%]' src={hero} alt="" /></div>
        </div>
    );
};
